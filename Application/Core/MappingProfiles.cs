...
namespace Application.Core
{
    public class MappingProfiles : Profile
    {
        public MappingProfiles()
        {
            ...
            CreateMap<Activity, Activity>();//specify where we gonna map to and from <From, To>
            CreateMap<Activity, ActivityDto>()//specify where we gonna map to and from <From, To>
